...
def src_interpolated(ctx, pert):
    ...
    Miller et al. 2025's own convention, matching the DE reference used everywhere else:
    ``wmse_weights``, the DEG-restriction spaces); blend toward the held-out replicate where
    the gene is significant, else toward the all-perturbed mean.
    """
