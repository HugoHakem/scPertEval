...
from ..blocks.spaces import degs_space, heg_space, pca_space, top_space
...
heg_k = Param("k", int, 1000, space=heg_space)  # top-k highly-expressed genes (Ahlmann-Eltze et al. 2025)
